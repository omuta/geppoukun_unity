...
namespace PreGeppou.Data {
    internal class TenkenTHatsudenData {
        ...
        public TenkenTHatsudenData() {
            ...
            //		henatukiData.add((HenatukiData) new HenatukiData(new Item("動力電灯第1バンク"), null, null, null));
        }
        public List<HenatukiData> getHenatukiData() {
            if (henatukiData[0].itemHenatukiMei == null) {
                henatukiData.Add((HenatukiData)new HenatukiData(new Item("電灯第1バンク"), null, null, null));
                henatukiData.Add((HenatukiData)new HenatukiData(new Item("動力第1バンク"), null, null, null));
                //			henatukiData.set(0, new HenatukiData(new Item("動力電灯第1バンク"), null, null, null));
            }
            return henatukiData;
        }
        ...
        public TenkenTHatsudenData clone() {
            TenkenTHatsudenData cloneSystemData = null;
            try {
                cloneSystemData = (TenkenTHatsudenData)clone();
            } catch (Exception e) {
                // 省略
            }
